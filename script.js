...
for (const i of names) {
  console.log("Hola mi nombres es " + i);
}
...
function saludar(nombre) {
  return "Hola, " + nombre + " bienvenida a la primera funcion";
}
console.log(saludar("Mafe"))
console.log(saludar("Cris"))
console.log(saludar("Victoria"))
console.log(saludar("Lours"))
